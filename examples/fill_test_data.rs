...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let create_analysis_response = |timestamp: u64, 
                                   ...
                                   legacy_calldata_gas: u64| -> String {
    ...
    let base_batches = vec![
        TrackedBatch {
            id: None,
            tx_hash: "0xbase1111111111111111111111111111111111111111111111111111111111111".to_string(),
        ...
        TrackedBatch {
            id: None,
            tx_hash: "0xbase2222222222222222222222222222222222222222222222222222222222222".to_string(),
            batcher_address: base_batcher.to_string(),
            analysis_result: create_analysis_response(
        ...
        TrackedBatch {
            id: None,
            tx_hash: "0xbase3333333333333333333333333333333333333333333333333333333333333".to_string(),
            batcher_address: base_batcher.to_string(),
            analysis_result: create_analysis_response(
    ...
    let optimism_batches = vec![
        TrackedBatch {
            id: None,
            tx_hash: "0xop111111111111111111111111111111111111111111111111111111111111111".to_string(),
        ...
        TrackedBatch {
            id: None,
            tx_hash: "0xop222222222222222222222222222222222222222222222222222222222222222".to_string(),
            batcher_address: optimism_batcher.to_string(),
            analysis_result: create_analysis_response(
        ...
        TrackedBatch {
            id: None,
            tx_hash: "0xop333333333333333333333333333333333333333333333333333333333333333".to_string(),
            batcher_address: optimism_batcher.to_string(),
            analysis_result: create_analysis_response(
